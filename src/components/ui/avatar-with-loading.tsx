...
const SIZE_VARIANTS = {
  sm: { container: 'w-8 h-8 min-w-8', icon: 'w-4 h-4', text: 'text-xs' },
  md: { container: 'w-12 h-12 min-w-12', icon: 'w-6 h-6', text: 'text-sm' },
  lg: { container: 'w-16 h-16 min-w-16', icon: 'w-8 h-8', text: 'text-base' },
  xl: { container: 'w-24 h-24 min-w-24', icon: 'w-12 h-12', text: 'text-lg' },
};
  ...
  function getFallbackIcon() {
    switch (type) {
      case 'org':
        return (
          <Building2
            className={cn(sizeClasses.icon, 'text-gray-500 dark:text-gray-400')}
          />
        );
      case 'repo':
        return (
